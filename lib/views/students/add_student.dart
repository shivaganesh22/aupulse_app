...
class _AddStudentViewState extends State<AddStudentView> {
              ...
              children: [
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'Hall Ticket',
                    hintText: 'Enter hallticket number',
                    border: OutlineInputBorder(),
                  ),
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Please enter hallticket number';
                    }
                    return null;
                  },
                  inputFormatters: [
  ...
  void _handleadd() async {
    ...
    if (_formKey.currentState!.validate()) {
      final Uri apiUrl =
          Uri.parse("https://aupulse-api.vercel.app/api/student/");
      final request = http.MultipartRequest('POST', apiUrl);
      request.fields.addAll({
        'hall_ticket': _hallticketController.text,
        'section': sectionid.toString(),
        'username': _hallticketController.text,
      ...
      if (_image != null) {
        ...
        showSnackBar(context, "Upload Profile Image", false);
      }
    }
  }
}