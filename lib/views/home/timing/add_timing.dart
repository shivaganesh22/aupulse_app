...
class AddTimingView extends StatefulWidget {
  const AddTimingView({Key? key}) : super(key: key);

  @override
  State<AddTimingView> createState() => _AddTimingViewState();
}

class _AddTimingViewState extends State<AddTimingView> {
  ...
  void _handleadd() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      http.Response res = await http.post(
        Uri.parse("https://aupulse-api.vercel.app/api/timing/"),
        body: {"name": name, "start": start, "end": end, "batch": batchId},
      );
