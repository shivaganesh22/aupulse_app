...
class SectionView extends StatefulWidget {
  final String id;
  const SectionView({Key? key, required this.id}) : super(key: key);
...
class _SectionViewState extends State<SectionView> {
  ...
  late String branchid, batchid,semesterid;
  Future<void> apicall() async {
    http.Response res = await http.get(Uri.parse(
        "https://aupulse-api.vercel.app/api/section/?branch=${branchid}"));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            backgroundColor: Colors.indigoAccent, title: Text("Sections"),   
        ),
        floatingActionButton: FloatingActionButton(
            onPressed: () async {
              await context.push(context.namedLocation("addSection",
                  pathParameters: {
                    "branchid": branchid,
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            trailing:
                              ...
                              if (value == 'edit') {
                                await context.push(
                                    context.namedLocation("editSection",
                                        pathParameters: {
                                          "batchid": batchid ,
                                          "semesterid":semesterid,
                                          "branchid": branchid ,
  ...
  Future<void> _handleDelete(id) async {
    ...
    http.Response res = await http
        .delete(Uri.parse("https://aupulse-api.vercel.app/api/section/${id}/"));
